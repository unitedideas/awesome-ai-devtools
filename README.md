...
- [AI Dev Jobs](https://aidevboard.com/) — Curated directory of 5,500+ AI/ML developer jobs from 289+ companies with a public REST API and MCP server for programmatic job search. [Source](https://github.com/unitedideas/ai-dev-jobs)
